...
# Optional: list root branch folders here (e.g., ["N24", "M32"]).
# Leave empty to auto-discover folders matching the pattern below.
_env_branches = os.getenv("BRANCH_FOLDERS", "").strip()
BRANCH_FOLDERS = [b.strip() for b in _env_branches.split(",") if b.strip()]
